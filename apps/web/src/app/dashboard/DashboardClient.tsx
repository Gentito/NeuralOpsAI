      ...
      <div className="grid gap-4 md:grid-cols-3">
        <Card title="Create Task">
          ...
          >
            ...
            <input
              ...
              className="w-full rounded-md border border-slate-800 bg-slate-950 px-3 py-2 text-sm"
            />
            <button type="submit" className="rounded-md bg-slate-200 px-3 py-2 text-sm font-medium text-slate-950 hover:bg-white">
              Add task
            </button>
          </form>
        </Card>
        ...
        <Card title="Orchestrate">
          ...
          >
            <textarea
              name="objective"
              placeholder="Describe the objective for your agents"
              className="min-h-[92px] w-full rounded-md border border-slate-800 bg-slate-950 px-3 py-2 text-sm"
            />
            <select
              name="projectId"
              className="w-full rounded-md border border-slate-800 bg-slate-950 px-3 py-2 text-sm"
